...
public class SyntaxColorTools {
    ...
    public static void addStylesToTextPane(JTextPane textPane) {
        ...
        StyleConstants.setForeground(brownStyle, new Color(147,10,10));
        ...
        Style normalBlue = textPane.addStyle("normal_blue", null);
        StyleConstants.setForeground(normalBlue, Color.BLUE);
    ...
    public void styleJavaCodeInDocument(JTextPane textPane, int beginIndex) {
        ...
        Style normalBlueStyle = textPane.getStyle("normal_blue");
        ...
        //styleBlock("\"", "\"", normalBlueStyle, document, text, beginIndex);
    }
